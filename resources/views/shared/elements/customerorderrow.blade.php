<tr class="order small" data-model="order" data-modelid="{{$order->id}}" id="order{{$order->id}}"
	...
	<td class="text-right order-buttons">
		<div class="submitted-buttons btn-group {{$order->status=="submitted" ? "": " hidden"}}">
		...
		<div class="packed-buttons btn-group{{$order->status=="packed" ? "": " hidden"}} btn-group-flex">
		...
		<div class="delivering-buttons btn-group {{$order->status=="delivering" ? "": " hidden"}}">
		...
		<div class="delivered-buttons btn-group {{$order->status=="delivered" ? "": " hidden"}}">
			<button value="{{$order->store->id}}" type="button" class="btn btn-danger order-cancel-button">
				Cancel
			</button>
		</div>
